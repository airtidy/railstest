...
RSpec.describe Ranking, type: :model do
  ...
  it "can calculate site-wide rankings correctly (With one single user)" do
	...
	it "can calculate site-wide rankings correctly (With three users and all ranks
	  the same)" do
	...
	it "can calculate site-wide rankings correctly (With 5 users and all ranks
	  differently)" do
	...
	it "calculates site-wide rankings correctly (With 5 users and some user did
	  not rank all)" do
